...
# ── VLM (Qwen2.5-VL) model constants ─────────────────────────────────────────
# llama-cpp-python 0.3.x uses Qwen25VLChatHandler; requires Qwen2.5-VL GGUF files.
# Source: unsloth/Qwen2.5-VL-7B-Instruct-GGUF on HuggingFace (need VPN in mainland China)
