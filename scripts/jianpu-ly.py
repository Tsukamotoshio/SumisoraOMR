...
# ---------------------------------------------------------------------------
# SumisoraOMR vendored copy (Apache-2.0 change notice, License section 4(b)).
# Base: official v1.866 (https://github.com/ssb22/jianpu-ly tag v1.866).
# Local modifications relative to that tag:
#   1. Added "\override Voice.Rest #'staff-position = #0" so stem direction
#      does not auto-shift rests upward.
#   2. "Tie #'transparent" / "Tie #'staff-position" rewritten as
#      "Tie.transparent" / "Tie.staff-position" (modern LilyPond syntax).
#   3. Fixed "sys.version_info()" typo -> "sys.version_info".
#   4. Wording tweak in the Python-version error message.
# ---------------------------------------------------------------------------
...
def jianpu_voice_start(isTemp=0):
    ...
    \override Voice.Rest #'staff-position = #0 %% fix: prevent stem-direction from auto-shifting rests up
...
(2) upgrade to Python 3.6 or above, and/or
