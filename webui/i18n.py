...
WEBUI_STRINGS: dict[str, dict[str, str]] = {
    ...
    "w.score.preview_ph": {"zh": "选中文件后在此预览", "en": "Select a file to preview it here"},
    ...
    "w.nd.import_failed": {"zh": "导入失败：{e}", "en": "Import failed: {e}"},
    "w.nd.help": {"zh": "帮助", "en": "Help"},
    "w.nd.help_tip": {"zh": "扒谱操作指南", "en": "Transcription guide"},
    "w.nd.help_title": {"zh": "扒谱操作指南", "en": "noteDigger Transcription Guide"},
    "w.nd.help_credit": {
        "zh": "noteDigger 是 madderscientist 的开源项目（GPL-3.0）。完整文档、视频教程与更新记录见其 GitHub 主页：github.com/madderscientist/noteDigger",
        "en": "noteDigger is an open-source project by madderscientist (GPL-3.0). Full docs, video tutorials and changelog: github.com/madderscientist/noteDigger",
    },
    ...
    "w.jp.new": {"zh": "新建简谱", "en": "New Score"},
    "w.jp.new_tip": {"zh": "新建空白简谱", "en": "Create a new blank jianpu score"},

    # ── 新建简谱向导（阶段1.5，B8.4 轻量版） ─────────────────────────────────
    "w.ns.title": {"zh": "新建简谱", "en": "New Jianpu Score"},
    "w.ns.field_title": {"zh": "标题", "en": "Title"},
    "w.ns.field_composer": {"zh": "作曲（可留空）", "en": "Composer (optional)"},
    "w.ns.field_key_mode": {"zh": "调式", "en": "Mode"},
    "w.ns.key_major": {"zh": "大调（1=X）", "en": "Major (1=X)"},
    "w.ns.key_minor": {"zh": "小调（6=X）", "en": "Minor (6=X)"},
    "w.ns.field_tonic": {"zh": "主音", "en": "Tonic"},
    "w.ns.field_timesig": {"zh": "拍号", "en": "Time signature"},
    "w.ns.field_tempo": {"zh": "速度（每分钟拍数）", "en": "Tempo (BPM)"},
    "w.ns.field_anacrusis": {"zh": "弱起（可选）", "en": "Pickup measure (optional)"},
    "w.ns.anacrusis_none": {"zh": "无弱起", "en": "None"},
    "w.ns.anacrusis_16": {"zh": "十六分音符（1/4 拍）", "en": "16th note (1/4 beat)"},
    "w.ns.anacrusis_16d": {"zh": "附点十六分音符（3/8 拍）", "en": "Dotted 16th note (3/8 beat)"},
    "w.ns.anacrusis_8": {"zh": "八分音符（1/2 拍）", "en": "8th note (1/2 beat)"},
    "w.ns.anacrusis_8d": {"zh": "附点八分音符（3/4 拍）", "en": "Dotted 8th note (3/4 beat)"},
    "w.ns.anacrusis_4": {"zh": "四分音符（1 拍）", "en": "Quarter note (1 beat)"},
    "w.ns.anacrusis_4d": {"zh": "附点四分音符（1.5 拍）", "en": "Dotted quarter note (1.5 beats)"},
    "w.ns.anacrusis_2": {"zh": "二分音符（2 拍）", "en": "Half note (2 beats)"},
    "w.ns.anacrusis_2d": {"zh": "附点二分音符（3 拍）", "en": "Dotted half note (3 beats)"},
    "w.ns.anacrusis_1": {"zh": "全音符（4 拍）", "en": "Whole note (4 beats)"},
    "w.ns.anacrusis_1d": {"zh": "附点全音符（6 拍）", "en": "Dotted whole note (6 beats)"},
    "w.ns.field_measures": {"zh": "初始小节数", "en": "Initial measure count"},
    "w.ns.field_voices": {"zh": "声部数", "en": "Number of voices"},
    "w.ns.create": {"zh": "创建", "en": "Create"},
    "w.ns.err_title_required": {"zh": "请输入标题", "en": "Please enter a title"},
    "w.ns.err_create_failed": {"zh": "创建失败：{e}", "en": "Failed to create: {e}"},
    ...
    "w.ed.graphical_tab": {"zh": "图形预览", "en": "Graphical"},
    "w.ed.graphical_placeholder": {"zh": "加载中…", "en": "Loading…"},
    "w.ed.graphical_parse_error": {"zh": "第 {line} 行解析失败：{message}", "en": "Parse failed at line {line}: {message}"},
    "w.ed.graphical_failed": {"zh": "图形预览加载失败：{e}", "en": "Failed to load graphical preview: {e}"},
    "w.ed.play": {"zh": "播放", "en": "Play"},
    ...
    "w.ed.input_mode": {"zh": "录入", "en": "Note input"},
    "w.ed.input_mode_on": {"zh": "已进入录入模式（Shift+N 或 Esc 退出）",
                           "en": "Note input mode on (Shift+N or Esc to leave)"},
    "w.ed.input_mode_off": {"zh": "已退出录入模式", "en": "Note input mode off"},
